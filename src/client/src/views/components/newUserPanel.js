export default function newUserPanel() {
  return (
    <div class="new-user-container">
      <form method="POST" action="users/new" class="new-user-form" id="new-user-form" onsubmit={handleSubmitFactory()}>
        ...
        <input class="new-user-submit-button" type="submit" value="Submit"/>
        </div>
      </form>
