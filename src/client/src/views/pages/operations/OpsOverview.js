...
const OpsOverview = () => {
  return (
    ...
    <div className="overview-page-container">
      ...
      the end of day ops manager a significant amount of time when planning out the next day&apos;s schedule.</p>
      ...
      we can create a truly useful app, tailored specifically to the needs of 1800GOTJUNK.</p>

      <p>Our primary aim is to finish the time and attendance sections of the app, later moving on to the aforementioned.</p>

      <p>So, on to the schedule builder. Each user added to the app via manage users, will be searchable in the
      ...
      <p>Take a look at the sidebar on the left, this allows you to populate the staff search results. For location,
      we currently have inner and outer caridnal directions, however in the future we may change this to actual suburbs.</p>

      <p>Staff members are added to routes by highlighting the staff member, highlighting the route, and clicking the add 
      route button. In the near future, we&apos;ll be allowing you to click and drag names onto routes. </p>
