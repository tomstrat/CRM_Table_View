...
function newuserpanel({ errors } = {}) {
    ...
    <div class="new-user-container">
      <form method="POST" action="users/new" class="new-user-form" id="new-user-form" onsubmit="handleFormSubmitAndGet(event)">
        ...
        <div class="valError" data-error="username">${(0, getError_1.default)(errors, "username")}</div>
        ...
        <div class="valError" data-error="password">${(0, getError_1.default)(errors, "password")}</div>
        ...
        <div class="valError" data-error="confirmPassword">${(0, getError_1.default)(errors, "confirmPassword")}</div>
